...
export function IconLink({
  ...
  return (
    <Link
      ...
      className={clsx(
        className,
        'group relative isolate flex items-center rounded-lg px-2 py-0.5 text-[0.8125rem]/6 font-medium text-gray-900/30 transition-colors hover:text-sky-300',
    ...
    >
      ...
      <span className="self-baseline text-gray-900">{children}</span>
    </Link>
  )
}
